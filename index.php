...
echo "<div class='panel panel-border panel-primary'>
									...
									<p align='right'><a class='btn btn-primary bg-pink' href='?p=barang&aksi=tambah'><i class='icon-plus'></i>Tambah Barang</a></p>
                                   <hr>
                                <table id='datatable' class='table table-hover'>
                                    ...
                                    <tbody>";
							$i=1;
							$tp=mysql_query("SELECT * FROM barang ORDER BY id");
...
break;
case "edit":
	$edit = mysql_query("SELECT * FROM barang WHERE id='$_GET[id]'");
