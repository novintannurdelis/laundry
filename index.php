...
?>
							...
							<?php } ?>
									 ...
									 <div class="form-group">
											...
											<pre>
*Setiap transaksi lebih dari 20kg akan mendapatkan potongan harga 10%</pre>
<button type="submit" class="btn btn-primary waves-effect waves-light bg-pink">Buat Transaksi</button>
</form>
                                     </div>
