        ...
        <div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                <div class="panel-heading bg-img"> 
                    ...
                    <h3 class="text-center m-t-10 text-white"> Silahkan Login untuk Masuk</h3>
                </div> 
...
?>
      <form class="form-horizontal m-t-20" id="form-login" action="proseslogin.php" method="POST">
                    ...
                    <div class="form-group text-center m-t-40">
                        <div class="col-xs-12">
                            <button class="btn btn-primary btn-lg w-lg waves-effect waves-light bg-pink" type="submit">Log In</button>
                        </div>
                    </div>
